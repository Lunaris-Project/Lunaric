...
class ThemeService extends Service {
    ...
    plasmaColorChanger = App.configDir + '/src/theme/bin/plasma-theme';
    plasmaColorsPath = App.configDir + '/src/theme/plasma-colors/';
    ...
    changeTheme(selectedTheme) {
        ...
        console.log('Changing to theme:', theme); // Debugging line
        if (!theme) {
            console.error('Theme not found:', selectedTheme);

            console.log('Theme properties:', {
                wallpaper_path: theme.wallpaper_path,
                gtk_mode: theme.gtk_mode,
                desktop_widget: theme.desktop_widget,
